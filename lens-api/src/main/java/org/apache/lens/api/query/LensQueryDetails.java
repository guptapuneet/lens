...
public class LensQueryDetails extends ToYAMLString implements LensQuery{
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof LensQuery)) {
      return false;
    }

    return this.getQueryHandle().equals(((LensQuery)other).getQueryHandle());
  }

  @Override
  public int hashCode() {
    return getQueryHandle().hashCode();
  }
