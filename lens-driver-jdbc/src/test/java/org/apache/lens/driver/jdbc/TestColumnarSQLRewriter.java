...
public class TestColumnarSQLRewriter {
  ...
  @Test
  public void testSubQuery() throws LensException {

    SessionState.start(hconf);

    //String query = "select t1.adv, t2.day, t1.burn from table1 t1 inner join table2 t2 on t1.dayid=t2.id where t2.day='monday' ";
    //String query ="SELECT fact.time_key,sum(fact.dollars_sold) FROM sales_fact fact INNER JOIN time_dim time_dim ON fact.time_key = time_dim.time_key WHERE time_dim.time_key BETWEEN '2013-01-01' AND '2013-01-31'  GROUP BY fact.time_key ";
    //String query ="SELECT fact1.time_key,  sum(fact1.dollars_sold) as msr1 FROM sales_fact1 fact1 GROUP BY fact1.time_key  union all SELECT fact2.time_key,  sum(fact2.dollars_sold) as msr1 FROM sales_fact2 fact2 GROUP BY fact2.time_key ";
    //String query ="select combined.status, sum(combined.endtime)endtime from ( select status ,sum(endtime)endtime from finished_queries1 group by status  union all select status,sum(endtime)end2 from finished_queries2 group by status) combined group by combined.status; ";
    //String query ="SELECT zipcode, `City ID`, MAX(`Measure 3`) as `Measure 3, COUNT(msr4), SUM(`Measure 2`) as `Measure 2` FROM (SELECT ( testcube . zipcode ), ( testcube . cityid ) as `City ID` , max(( testcube . msr3 )) as `Measure 3` , count(( testcube . msr4 )), sum(( testcube . msr2 )) as `Measure 2`  FROM TestQueryRewrite.c1_testfact testcube WHERE ((((((((((((((((((((((((((((((((((((((((((((((((((((((((( testcube . dt ) =  '2015-08-29-18' ) or (( testcube . dt ) =  '2015-08-29-19' )) or (( testcube . dt ) =  '2015-08-29-20' )) or (( testcube . dt ) =  '2015-08-29-21' )) or (( testcube . dt ) =  '2015-08-29-22' )) or (( testcube . dt ) =  '2015-08-29-23' )) or (( testcube . dt ) =  '2015-08-30' )) or (( testcube . dt ) =  '2015-08-31' )) or (( testcube . dt ) =  '2015-10-01' )) or (( testcube . dt ) =  '2015-10-02' )) or (( testcube . dt ) =  '2015-10-03' )) or (( testcube . dt ) =  '2015-10-04' )) or (( testcube . dt ) =  '2015-10-05' )) or (( testcube . dt ) =  '2015-10-06' )) or (( testcube . dt ) =  '2015-10-07' )) or (( testcube . dt ) =  '2015-10-08' )) or (( testcube . dt ) =  '2015-10-09' )) or (( testcube . dt ) =  '2015-10-10' )) or (( testcube . dt ) =  '2015-10-11' )) or (( testcube . dt ) =  '2015-10-12' )) or (( testcube . dt ) =  '2015-10-13' )) or (( testcube . dt ) =  '2015-10-14' )) or (( testcube . dt ) =  '2015-10-15' )) or (( testcube . dt ) =  '2015-10-16' )) or (( testcube . dt ) =  '2015-10-17' )) or (( testcube . dt ) =  '2015-10-18' )) or (( testcube . dt ) =  '2015-10-19' )) or (( testcube . dt ) =  '2015-10-20' )) or (( testcube . dt ) =  '2015-10-21' )) or (( testcube . dt ) =  '2015-10-22' )) or (( testcube . dt ) =  '2015-10-23' )) or (( testcube . dt ) =  '2015-10-24' )) or (( testcube . dt ) =  '2015-10-25' )) or (( testcube . dt ) =  '2015-10-26' )) or (( testcube . dt ) =  '2015-10-27' )) or (( testcube . dt ) =  '2015-10-28' )) or (( testcube . dt ) =  '2015-10-29-00' )) or (( testcube . dt ) =  '2015-10-29-01' )) or (( testcube . dt ) =  '2015-10-29-02' )) or (( testcube . dt ) =  '2015-10-29-03' )) or (( testcube . dt ) =  '2015-10-29-04' )) or (( testcube . dt ) =  '2015-10-29-05' )) or (( testcube . dt ) =  '2015-10-29-06' )) or (( testcube . dt ) =  '2015-10-29-07' )) or (( testcube . dt ) =  '2015-10-29-08' )) or (( testcube . dt ) =  '2015-10-29-09' )) or (( testcube . dt ) =  '2015-10-29-10' )) or (( testcube . dt ) =  '2015-10-29-11' )) or (( testcube . dt ) =  '2015-10-29-12' )) or (( testcube . dt ) =  '2015-10-29-13' )) or (( testcube . dt ) =  '2015-10-29-14' )) or (( testcube . dt ) =  '2015-10-29-15' )) or (( testcube . dt ) =  '2015-10-29-16' )) or (( testcube . dt ) =  '2015-10-29-17' )))) GROUP BY ( testcube . zipcode ), ( testcube . cityid ) UNION ALL SELECT ( testcube . zipcode ), ( testcube . cityid ) as `City ID` , max(( testcube . msr3 )) as `Measure 3` , count(( testcube . msr4 )), sum(( testcube . msr2 )) as `Measure 2`  FROM TestQueryRewrite.c2_testfact testcube WHERE (((( testcube . dt ) =  '2015-09' ))) GROUP BY ( testcube . zipcode ), ( testcube . cityid )) combined GROUP BY zipcode,`City ID`" ;
    String query = "select  geo.location_name, sum(sales.dollars_sold) as revenue  from sales_fact as sales inner join (select location_key, location_name from location_dim ) as geo  on sales.location_key =  geo.location_key  where  geo.location_key in (select location_key from location_dim where location_key > 100)  having sum(sales.units_sold) >10 order by revenue desc  limit 10";
    String actual = qtest.rewrite(query, conf, hconf);
