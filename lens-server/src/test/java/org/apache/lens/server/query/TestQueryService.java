...
public class TestQueryService extends LensJerseyTest {
  ...
  public void testExecuteAsync(MediaType mt) throws InterruptedException, IOException, LensException {
    ...
    // and Fetch result should fail before query is marked successful and result path should be correct
    ...
    try {
      ...
      assert false : "client should not be allowed to fetch result before query finishes successfully";
